...
window.addEventListener("load", function () {
    function sendData() {
        ...
        xhr.open("POST", "trait-insert-salaire.php");
        xhr.send(formData);
    }
    ...
    function afficherData() {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4) {
                if (xhr.status == 200) {
                    ...
                    th1.innerHTML = "<span style='color: rgb(3, 3, 3);'>Salaire</span>";
                    th2.innerHTML = "<span style='color: rgb(3, 3, 3);'>id idCueilleur</span>";
                    ...
                    for (var i = 0; i < retour.length; i++) {
                        (function(index){
                            var indice= retour[i].idSalaire;
                            var tr = document.createElement("tr");
                            var td1 = document.createElement("td");
                            var td2 = document.createElement("td");
                            var td3 = document.createElement("td");
                            var td4 = document.createElement("td");
                            td1.innerHTML = retour[i].salaire;
        ...
        xhr.open("GET", "get-salaire.php", true);
        xhr.send(null);
    }
    ...
    function supprimer(id){
                ...
                xhr.open("GET", "supprimer-salaire.php?idsup=" + id, true);
                xhr.send(null);
            }
                    ...
                    <div class="card mb-5" style="transform: scale(1);">
                        <div class="card-body d-flex flex-column align-items-center" style="width: 881px;transform: translate(-229px);background: var(--bs-green);border-color: var(--bs-body-bg);">
                                                    ...
                                                    <div class="container position-relative">
                                                        <div class="row mb-5">
                                                            <div class="col-md-8 col-xl-6 text-center mx-auto" style="background: #2b4c3f;">
                                                                ...
                                                                <p class="w-lg-50">SALAIRES PAR KG DES CUEILLEURS</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row d-flex justify-content-center">
                                                            <div class="col-md-6 col-lg-5 col-xl-4" style="width: 354.9px;">
                                                                <div>
                                                                    <form class="p-3 p-xl-4" method="post" id="formulaire">
                                                                        <div class="mb-3"><input class="form-control" type="number" id="name-1" name="salaire" placeholder="id Cueilleur"></div>
                                                                        <div class="mb-3"><input class="form-control" type="number" id="name-1" name="idcueilleur" placeholder="Salaire par Kg"></div>
                                                                        <div style="margin-bottom: 12px;"></div>
                                                                        <div class="mb-3"></div>
                                                                        <div class="mb-3"></div>
                                                                        <div><button class="btn btn-primary d-block w-100" type="submit" style="margin-bottom: 5px;">Inserer salaire</button><button class="btn btn-primary d-block w-100" type="submit">Update</button></div>
                                                                    </form>
                                                                </div>
                                                            </div>
                                                        </div>
                            ...
                            <div class="text-white bg-dark border rounded border-0 p-4 p-md-5" style="width: 770px;transform: translate(-36px);margin-left: 100px;">
                                <h2 class="fw-bold text-white mb-3">LISTE DES SALAIRES</h2>
